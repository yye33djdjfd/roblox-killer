...
async def create_outfit(session, username, ids=None, payload_avatar=None):
    if not payload_avatar:
        payload = {"name": "Jo e x Is HeRe !", "bodyColors": {"headColorId": 18, "torsoColorId": 18, "rightArmColorId": 18, "leftArmColorId": 18, "rightLegColorId": 18, "leftLegColorId": 18}, "assetIds": ids, "scale": {"height": 1, "width": 1, "head": 1, "depth": 1, "proportion": 1, "bodyType": 1}}
    else:
