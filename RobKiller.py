...
class Main:
    ...
    def display_theme(self, banner=None):
        os.system('cls' if os.name == 'nt' else 'clear')
        MAIN_COLOR: Color = Color(179, 2, 2)
        ACCENT_COLOR: Color = Color(179, 2, 2)
        ...
        ╚═╝░░╚═╝░╚════╝░╚═════╝░╚═╝░░╚═╝╚═╝╚══════╝╚══════╝╚══════╝╚═╝░░╚═╝
           ...
           Made By Mr.Joex | https://guns.lol/0xmrjoex
         """
        TEXT_IN_BOX: str = "Roblox Killer By Mr.Joex"
        SIGNATURE: str = f"""
    ...
    async def main(self):
        while True:
            ...
            choice = input(f"""{Color(179, 2, 2)}┌───({Color(179, 2, 2)}{username_pc}@root{Color(179, 2, 2)})─[{Color(179, 2, 2)}~{Color(179, 2, 2)}]
└──{Color(179, 2, 2)}$ """)
